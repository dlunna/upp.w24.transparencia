const APPS = [
  ...
  },
  {
    nombre:"Esit Móvil",
    image: "https://cdn.hidalgo.gob.mx/www/apps/app.png",
    desc: "Las aplicaciones móviles cada vez se convierten en poderosas herramientas que facilitan las actividades diarias de las personas, la Secretaria de Finanzas Publicas del Estado de Hidalgo consiente de tal necesidad, publica la primer APP que permite realizar pagos en línea con los niveles de seguridad necesarios Permitiendo:<br><br>Pago de Tenencia<br>Pago en ventanilla.<br>Consulta y pago de referencias.<br>Servicios Internos.",
    urlas: "https://apps.apple.com/mx/app/esit-m%C3%B3vil/id1443970983",
    urlps:"#"
  }
];
